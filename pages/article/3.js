    ...
    <ArticleLayout>
      <section>
        ...
        <article className="max-w-5xl mt-24 pb-28 mx-auto">
          ...
          <div className="relative w-[668px] h-[494px] mt-8 mb-10 mx-auto">
            <Image src={MODEL_IMAGE[currentLocal]} alt="" />
          </div>
          <p className="article-p my-7">{t('p4')}</p>
          <p className="article-p my-7">{t('p5')}</p>
          <div className="article-p my-7" dangerouslySetInnerHTML={{ __html: t.raw('p6') }} />
          <div className="relative mt-8 mb-10 mx-auto">
            <Image src={Article3Formula1} alt="" />
          </div>
          <div className="article-p my-7" dangerouslySetInnerHTML={{ __html: t.raw('p7') }} />
          <div className="relative mt-8 mb-10 mx-auto">
          ...
          <div className="article-p my-7" dangerouslySetInnerHTML={{ __html: t.raw('p9') }} />
          <div className="relative mt-8 mb-10 mx-auto">
          ...
          <div className="article-p my-7" dangerouslySetInnerHTML={{ __html: t.raw('p11') }} />
          <div className="relative flex flex-col gap-y-4 w-[651px] h-[213px] mt-8 mb-10 mx-auto">
            <Image src={Article3Formula5} alt="" />
            <p className="text-lg text-[#1a487f] text-center">{t('caption')}</p>
          </div>
          <div className="article-p my-7" dangerouslySetInnerHTML={{ __html: t.raw('p12') }} />
          <div className="relative mt-8 mb-10 mx-auto">
